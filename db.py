...
class PostgresDb(object):
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            try:
                connection = psycopg2.connect(user="postgres", password="56azilos", host="127.0.0.1", port="5432",
                                              database="Alexey")
                cursor = connection.cursor()
                engine = create_engine('postgresql+psycopg2://postgres:56azilos@localhost/Alexey')
                ...
                print("Error connection to PostgreSQL", error)
